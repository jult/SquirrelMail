...
/**
 *      * Code courtesy of
 *      * Sourceforge phpMyAdmin project [ http://www.phpmyadmin.net/
 *      * Just made a few slight changes / additions for our purposes
 *
 */
...
class zipfile {
     ...
     * @param  string   name of the file in the archive (may contain the path)
    ...
    function addFile($data, $name, $time = 0) {
        ...
        if (strlen($name) > 200) $name=substr(0,200);
