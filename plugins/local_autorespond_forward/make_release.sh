...
#
#
CONFIG_FILES=( config.php squirrelmail_autoresponder_forwarder_proxy suid_backend/aclocal.m4 suid_backend/autom4te.cache suid_backend/config.h suid_backend/config.h.in~ suid_backend/config.log suid_backend/config.status suid_backend/.deps suid_backend/Makefile suid_backend/squirrelmail_autoresponder_forwarder_proxy.o suid_backend/squirrelmail_autoresponder_forwarder_proxy suid_backend/stamp-h1 )
